...
> Answer: It's faster on the client side, gets rid of whole pages reloading with white screan.
- [ ] What does AJAX stand for?
> Answer: It stands for asynchronous JavaScript and XML.
- [ ] What are `controlled components` in React?
> Answer: I think this refers to the parent child relationsship, everything goes through one component, and it is controled on react by that component.
